const cardsInfo = {
  "container": {
      "titulo": "Precisando de ajuda, está no lugar certo!",
...
const tituloCard = cardsInfo.container["titulo"]
const infoCard = cardsInfo.container["info"]
const cardTittle01 = document.querySelectorAll(".info__page-sub")[0].innerText=tituloCard
const cardInfo01 = document.querySelectorAll(".info__page-txt")[0].innerText=infoCard
